...
class RecordFileQ6
{
  ...
  void displayRecords(String filename) throws IOException
  {
    ...
    if(inFile.exists())
    {
      ...
      {
        // How many records have been written to the
        // file and how many records are being read?
        int roll=Integer.parseInt(fin.nextLine());
        String name=fin.nextLine();
        // int std=Integer.parseInt(fin.nextLine()); <-- Mistake
  ...
  {
    RecordFileQ6 obj=new RecordFileQ6();
